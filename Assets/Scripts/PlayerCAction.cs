...
public class PlayerCAction:MonoBehaviour
{
    float h; // 水平軸
    float v; // 垂直軸
    Vector3 Dir; // 移動方向
    ...
    void Start() {
        ...
        if (PlayerPrefs.HasKey("player1Character"))
        {
            switch (PlayerPrefs.GetInt("player1Character")) {
                case 1:
                    obj = (GameObject)Instantiate(chara1, new Vector3(-30.95f, 13.25f, 3.65f), Quaternion.identity);
                    obj.transform.rotation = Quaternion.Euler(0.0f, 0.0f, 0.0f);
                    obj.gameObject.transform.localScale = new Vector3(10.0f * 0.1f, 10.0f * 0.1f, 10.0f * 0.1f);
                    obj.transform.parent = playerObject.transform;
                    charaAcc = 4.0f * 0.2f;
                    charaSpeed = 9.0f * 0.2f;
                    charaRot = 72.0f;
                    break;
                case 2:
                    obj = (GameObject)Instantiate(chara2, new Vector3(-30.95f, 13.25f, 3.65f), Quaternion.identity);
                    obj.transform.rotation = Quaternion.Euler(0.0f, 0.0f, 0.0f);
                    obj.gameObject.transform.localScale = new Vector3(15.0f * 0.1f, 15.0f * 0.1f, 15.0f * 0.1f);
                    obj.transform.parent = playerObject.transform;
                    charaAcc = 3.0f * 0.2f;
                    charaSpeed = 10.0f * 0.2f;
                    charaRot = 144.0f;
                    break;
                case 3:
                    obj = (GameObject)Instantiate(chara3, new Vector3(-30.95f, 13.4f, 3.65f), Quaternion.identity);
                    obj.transform.rotation = Quaternion.Euler(0.0f, 0.0f, 0.0f);
                    obj.gameObject.transform.localScale = new Vector3(20.0f * 0.1f, 20.0f * 0.1f, 20.0f * 0.1f);
                    obj.transform.parent = playerObject.transform;
                    charaAcc = 2.0f * 0.2f;
                    charaSpeed = 12.0f * 0.2f;
                    charaRot = 72.0f;
                    break;
                case 4:
                    obj = (GameObject)Instantiate(chara4, new Vector3(-30.95f, 13.25f, 3.65f), Quaternion.identity);
                    obj.transform.rotation = Quaternion.Euler(0.0f, 0.0f, 0.0f);
                    obj.gameObject.transform.localScale = new Vector3(10.0f * 0.1f, 10.0f * 0.1f, 10.0f * 0.1f);
                    obj.transform.parent = playerObject.transform;
                    charaAcc = 4.0f * 0.2f;
                    ...
                    break;
                case 5:
                    obj = (GameObject)Instantiate(chara5, new Vector3(-30.95f, 13.25f, 3.65f), Quaternion.identity);
                    obj.transform.rotation = Quaternion.Euler(0.0f, 0.0f, 0.0f);
                    obj.gameObject.transform.localScale = new Vector3(20.0f * 0.1f, 20.0f * 0.1f, 20.0f * 0.1f);
                    obj.transform.parent = playerObject.transform;
                    charaAcc = 3.0f * 0.2f;
                    ...
                    break;
                case 6:
                    obj = (GameObject)Instantiate(chara6, new Vector3(-30.95f, 13.25f, 3.65f), Quaternion.identity);
                    obj.transform.rotation = Quaternion.Euler(0.0f, 0.0f, 0.0f);
                    obj.gameObject.transform.localScale = new Vector3(20.0f * 0.1f, 20.0f * 0.1f, 20.0f * 0.1f);
                    obj.transform.parent = playerObject.transform;
                    charaAcc = 2.0f * 0.2f;
                    charaSpeed = 11.0f * 0.2f;
                    charaRot = 144.0f;
                    break;
                case 7:
                    obj = (GameObject)Instantiate(chara7, new Vector3(-30.95f, 13.25f, 3.65f), Quaternion.identity);
                    obj.transform.rotation = Quaternion.Euler(0.0f, 0.0f, 0.0f);
                    obj.gameObject.transform.localScale = new Vector3(0.4f * 0.1f, 0.4f * 0.1f, 0.4f * 0.1f);
                    obj.transform.parent = playerObject.transform;
                    charaAcc = 3.0f * 0.2f;
                    charaSpeed = 11.0f * 0.2f;
                    charaRot = 36.0f;
                    break;
                case 8:
                    obj = (GameObject)Instantiate(chara8, new Vector3(-30.95f, 13.2f, 3.65f), Quaternion.identity);
                    obj.transform.rotation = Quaternion.Euler(0.0f, 0.0f, 0.0f);
                    obj.gameObject.transform.localScale = new Vector3(20.0f * 0.1f, 20.0f * 0.1f, 20.0f * 0.1f);
                    obj.transform.parent = playerObject.transform;
                    charaAcc = 2.0f * 0.2f;
