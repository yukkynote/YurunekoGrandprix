...
public class EnemyBAction : MonoBehaviour
{
    ...
    Vector3[] DestinationPos = new Vector3[] {
        ...
        */
        new Vector3(-16.7f,0.5f,-45.9f),
        new Vector3(-32.6f,0.5f,-45.9f),
        new Vector3(-34.0f,0.5f,-35.8f),
        new Vector3(-34.7f,0.5f,-28.0f),
        new Vector3(-47.6f,0.5f,-22.8f),
        new Vector3(-52.4f,0.5f,-27.0f),
        new Vector3(-51.7f,0.5f,-35.7f),
        new Vector3(-40.1f,0.5f,-36.4f),
        new Vector3(-26.7f,0.5f,-35.1f),
        new Vector3(-23.6f,0.5f,-23.8f),
        new Vector3(-17.6f,0.5f,-23.8f),
        new Vector3(-15.6f,0.5f,-31.8f),
    }; 
