...
public class Player2Action:MonoBehaviour
{
    ...
    void Start() {
        ...
        mainCamera2 = GameObject.FindGameObjectWithTag("MainCamera2");
        checkCount = 0;
        ...
        if (PlayerPrefs.HasKey("player2Character")) {
            switch (PlayerPrefs.GetInt("player2Character")) {
                case 1:
                    obj = (GameObject)Instantiate(chara1, new Vector3(0, -0.1f, 0), Quaternion.identity);
                    ...
                    obj.transform.parent = player2Object.transform;
                    charaAcc = 4.0f;
                    charaSpeed = 9.0f;
                    charaRot = 72.0f;
                    break;
                case 2:
                    obj = (GameObject)Instantiate(chara2, new Vector3(0, -0.1f, 0), Quaternion.identity);
                    obj.transform.rotation = Quaternion.Euler(0.0f, 180.0f, 0.0f);
                    ...
                    break;
                case 3:
                    obj = (GameObject)Instantiate(chara3, new Vector3(0, 0.05f, 0), Quaternion.identity);
                    obj.transform.rotation = Quaternion.Euler(0.0f, 180.0f, 0.0f);
                    ...
                    break;
                case 4:
                    obj = (GameObject)Instantiate(chara4, new Vector3(0, -0.1f, 0), Quaternion.identity);
                    obj.transform.rotation = Quaternion.Euler(0.0f, 180.0f, 0.0f);
                    obj.gameObject.transform.localScale = new Vector3(10.0f * 0.15f, 10.0f * 0.15f, 10.0f * 0.15f);
                    obj.transform.parent = player2Object.transform;
                    charaAcc = 4.0f;
                    ...
                    break;
                case 5:
                    obj = (GameObject)Instantiate(chara5, new Vector3(0, -0.1f, 0), Quaternion.identity);
                    obj.transform.rotation = Quaternion.Euler(0.0f, 180.0f, 0.0f);
                    obj.gameObject.transform.localScale = new Vector3(20.0f * 0.15f, 20.0f * 0.15f, 20.0f * 0.15f);
                    obj.transform.parent = player2Object.transform;
                    charaAcc = 3.0f;
                    ...
                    break;
                case 6:
                    obj = (GameObject)Instantiate(chara6, new Vector3(0, -0.1f, 0), Quaternion.identity);
                    obj.transform.rotation = Quaternion.Euler(0.0f, 180.0f, 0.0f);
                    obj.gameObject.transform.localScale = new Vector3(20.0f * 0.15f, 20.0f * 0.15f, 20.0f * 0.15f);
                    obj.transform.parent = player2Object.transform;
                    charaAcc = 2.0f;
                    ...
                    break;
                case 7:
                    obj = (GameObject)Instantiate(chara7, new Vector3(0, -0.1f, 0), Quaternion.identity);
                    obj.transform.rotation = Quaternion.Euler(0.0f, 180.0f, 0.0f);
                    ...
                    break;
                case 8:
                    obj = (GameObject)Instantiate(chara8, new Vector3(0, -0.15f, 0), Quaternion.identity);
                    obj.transform.rotation = Quaternion.Euler(0.0f, 180.0f, 0.0f);
                    obj.gameObject.transform.localScale = new Vector3(20.0f * 0.15f, 20.0f * 0.15f, 20.0f * 0.15f);
                    obj.transform.parent = player2Object.transform;
                    charaAcc = 2.0f;
    ...
    void Update() {
        if (isGoal/*myAgent.enabled*/) {
            ...
            h = Input.GetAxis("Horizontal2"); // 入力デバイスの水平軸
            v = Input.GetAxis("Vertical2"); // 入力デバイスの垂直軸
    ...
    void AddSpeed() {
        ...
        mainCamera2.SendMessage("Dash", SendMessageOptions.DontRequireReceiver);
    ...
    void OnTriggerEnter(Collider other) {
        if (other.gameObject == checkPoint1 && checkCount == 0) {
            ...
            /*
            // 検証用
            GameObject.Find("GameManager").SendMessage("Goal2", SendMessageOptions.DontRequireReceiver);
            //myAgent.enabled = true;
            isGoal = true;

            mainCamera2.SendMessage("Goal", SendMessageOptions.DontRequireReceiver);
            */
        }
